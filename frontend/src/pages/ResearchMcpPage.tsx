...
import { streamResearchMcp } from '../lib/api';
import { ArxivPaper } from '../types/chat';

interface ResearchMcpPageProps {
  accessToken: string;
  userEmail: string;
  onBack: () => void;
}
...
export function ResearchMcpPage({ accessToken, userEmail, onBack }: ResearchMcpPageProps) {
    ...
    <div className="ra-page">
      ...
      <header className="ra-topbar">
        ...
        <div className="ra-topbar-center">
          ...
          <span className="ra-mcp-badge">MCP-powered</span>
        </div>
      ...
      <div className="ra-body">
        ...
        <section className="ra-query-section">
          <div className="ra-query-header">
            <h2 className="ra-query-title">Explore arXiv Research via MCP</h2>
            <p className="ra-query-subtitle">
              Enter any research topic — the agent uses an{' '}
              <strong>MCP (Model Context Protocol) server</strong> to search arXiv, evaluates
              papers, and streams a structured digest in real time.
            </p>
          </div>
          ...
          <div className="ra-input-row">
            ...
            <div className="ra-input-actions">
              {researching ? (
                ...
                <button
                  className="ra-research-btn ra-research-btn-mcp"
        ...
        {statusMessages.length > 0 && (
          <section className="ra-status-section">
            <div className="ra-status-header">Research Progress (MCP)</div>
        ...
        {papers.length > 0 && (
          <section className="ra-papers-section">
            <div className="ra-section-header">
              <span className="ra-section-title">Papers Found via MCP</span>
        ...
        {digestDone && (
          <section className="ra-followup-section">
            <div className="ra-followup-label">🔄 Follow-up Research (MCP)</div>
